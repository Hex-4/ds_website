    ...
    return (
        <div id="page" className="fixed top-0 left-16 float-right overflow-scroll-y bg-primary h-screen z-0">
            ...
            <div className="grid grid-cols-4 grid-rows-3 gap-4 w-full m-8">
                <div className="group row-span-3 p-8 bg-slate-800 rounded-lg hover:from-secondary hover:to-orange-500 hover:bg-gradient-to-tr transition-all duration-1000"><p className="norm-text text-5xl">We're <b className="text-secondary group-hover:text-blue-600 transition-all ">Diamond Studios</b>, a bunch of people trying to make the world cooler.</p></div>
            </div>
